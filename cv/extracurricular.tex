...
%---------------------------------------------------------
\cventry
{Qualification Task} % Affiliation/role
{European Organization for Nuclear Research - CERN} % Organization/group
{Geneva, CHE} % Location
{Mar. 2025 - Currenctly} % Date(s)
{
  \begin{cvitems} % Description(s) of experience/contributions/knowledge
    \item {Trigger algorithm development.}
    \item {VHDL development for FPGA.}
    % \item {Tools: Vivado, HoG: HDL on git.}
  \end{cvitems}
}
...
%---------------------------------------------------------
  \cventry
    ...
    {Polytechnic School of the Federal University of Bahia - UFBRA} % Organization/group
    {Salvador, BRA} % Location
