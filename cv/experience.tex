...
\cventry
   ...
   {The European Organization for Nuclear Research - CERN} % Organization
   {Geneva, CHE} % Location
   {Jan. 2024 - Currenctly} % Date(s)
   {
     \begin{cvitems} % Description(s) of tasks/responsibilities
       \item {Development triggered event algorithm based on FPGA for the ATLAS experiment at the Large Hadron Collider.}
       \item {Successfully completed the ATLAS Collaboration authorship qualification project on FPGA-based implementation and optimization of the NeuralRinger algorithm for the Level-0 Global Trigger, and was accepted as a full signing member of the ATLAS Collaboration (2026).}
     \end{cvitems}
   }
...
\cventry
  ...
  {Salvador, BRA} % Location
  {Apr. 2022 - Dec. 2023} % Date(s)
  {
    \begin{cvitems} % Description(s) of tasks/responsibilities
