...
%---------------------------------------------------------
  \cventry
    {Postgraduate Research Visiting Student Department Physics and Astronomy} % 
    {The University of Manchester} % Institution
    {Manchester, GBR} % Location
    {Mar. 2025 - Currenctly} % Date(s)
    {
      \begin{cvitems} % Description(s) bullet points
        \item {Visiting student as part of my PhD studies.}
      \end{cvitems}
    }
