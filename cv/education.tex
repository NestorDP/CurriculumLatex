...
%---------------------------------------------------------
  \cventry
    ...
    {Mar. 2022 - Mar. 2027} % Date(s)
    {
      % \begin{cvitems} % Description(s) bullet points
      %   \item {Study of the use of FPGA for migration of calibration step algorithms of the Event Selection Online system in the detector ATLAS.}
      % \end{cvitems}
    }
